...
| --- | --- | --- | --- | --- | --- |
| `.github/workflows/ci-quality-security.yml` | CREATED | Named GitHub Actions quality, build, migration-boundary, Rust/Tauri runner setup, secret-scan, and artifact-evidence checks. | CX-R1-002 | CI baseline | Required GitHub workflow-location exception; reviewed locally. |
