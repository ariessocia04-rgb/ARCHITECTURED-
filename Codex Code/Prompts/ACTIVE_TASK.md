...
→ READ PROMPT 0001, THEN EXECUTE PROMPT 0002, TASK RECORD, TASK CONTRACT, CHECKPOINT, AND REVIEW HANDOFF
→ WORK ONLY ON governance/codex-execution-modes
→ CHANGE ONLY THE EXACT PATHS AUTHORIZED BY TASK_CONTRACT.md
